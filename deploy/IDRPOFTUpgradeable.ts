...
/// @dev Replace IDRPOFTUpgradeable with the OFT you are deploying: i.e. IDRPOFTFeeUpgradeable, IDRPOFTUpgradeableMock
const contractName = "IDRPOFTUpgradeable";
...
deploy.tags = ["IDRPOFTUpgradeable"];
