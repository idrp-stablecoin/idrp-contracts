...
// ─────────────────────────────────────────────────────────────────────────────
// LEGACY snapshot for BASE SEPOLIA only — DO NOT EDIT.
//
// Base Sepolia's IDRPController was deployed at a v1.5 source draft that
// inherits BOTH AccessControlUpgradeable AND OwnableUpgradeable, includes the
// signed-quorum + timelock additions, but has NOT yet been migrated to the
// single-`upgrader` slot (no `upgrader` slot, no initializeV2).
//
// Source-of-truth: deployment/logs/contracts/v2.baseSepolia.IDRPController.sol
// (manually pulled from Basescan-verified bytecode at the live impl).
//
// This file exists ONLY so scripts/v1-to-v2/ can migrate Base Sepolia by first
// upgrading to IDRPControllerv2.sol (which removes Ownable in favour of
// `upgrader`). validateUpgrade against this file → IDRPControllerv2 must pass
// before the migration runs.
//
// Renames applied:
//   contract IDRPController → IDRPControllerBaseSepoliaLegacy
//   interface IIDRP → IIDRPBSL
// ─────────────────────────────────────────────────────────────────────────────
...
contract IDRPControllerBaseSepoliaLegacy is
    Initializable,
