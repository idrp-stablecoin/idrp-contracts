...
// LAYOUT FIXTURE — the v3 source as it stood BEFORE confiscate was added
// (commit 442a0b7). This is the shape the four EVM mainnets are running today.
// Kept so `test/confiscate/UpgradePaths.ts` can prove that the production
// upgrade path into the current layout validates, instead of that being
// something somebody once checked by hand.
...
contract IDRPv3NoConfiscate is
    Initializable,
    ERC20Upgradeable,
