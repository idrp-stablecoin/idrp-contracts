...
// ─────────────────────────────────────────────────────────────────────────────
// LEGACY v3 SNAPSHOT — DO NOT EDIT THIS FILE. NEVER DEPLOY IT.
//
// The v3 controller as it stood before an operation identifier could be
// consumed only once. It is the upgrade-from source for fork rehearsals.
//
// The only edits applied vs that source:
//   - contract IDRPController  → contract IDRPControllerv3   (avoid name collision)
//   - interface IIDRP          → IIDRPv3                     (avoid name collision)
//
// Function bodies and storage layout are UNCHANGED.
// ─────────────────────────────────────────────────────────────────────────────
