    ...
    TronUUPSUpgradeable
{
    ...
    /// @dev DEPRECATED ΓÇö no longer used for replay protection.
    ...
    function executeOperation(
        ...
        // Cache idrpToken ΓÇö single SLOAD instead of one per branch
    ...
    // ΓöÇΓöÇΓöÇ Upgrade scheduling ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
